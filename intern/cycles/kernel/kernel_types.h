...
enum ShaderDataShaderFlag {
	...
	/* shader flags */
	SD_USE_MIS					   = (1 << 0),  /* direct light sample */
	SD_HAS_TRANSPARENT_SHADOW	   = (1 << 1),  /* has transparent shadow */
	SD_HAS_VOLUME				   = (1 << 2),  /* has volume shader */
	SD_HAS_ONLY_VOLUME			   = (1 << 3),  /* has only volume shader, no surface */
	SD_HETEROGENEOUS_VOLUME		   = (1 << 4),  /* has heterogeneous volume */
	SD_HAS_BSSRDF_BUMP			   = (1 << 5),  /* bssrdf normal uses bump */
	SD_VOLUME_EQUIANGULAR		   = (1 << 6),  /* use equiangular sampling */
	SD_VOLUME_MIS				   = (1 << 7),  /* use multiple importance sampling */
	SD_VOLUME_CUBIC				   = (1 << 8),  /* use cubic interpolation for voxels */
	SD_HAS_BUMP					   = (1 << 9),  /* has data connected to the displacement input */
	SD_HAS_DISPLACEMENT			   = (1 << 10), /* has true displacement */
	SD_HAS_CONSTANT_EMISSION	   = (1 << 11), /* has constant emission (value stored in __shader_flag) */
	SD_USE_UNIFORM_ALPHA		   = (1 << 12), /* uses a uniform alpha instead of evaluating shaders */
	SD_USE_UNIFORM_ALPHA_SELF_ONLY = (1 << 13), /* uniform alpha only affect shading self */
	SD_OVERRIDE_SAMPLES			   = (1 << 14), /* override samples */
	SD_OVERRIDE_BOUNCES			   = (1 << 15), /* override bounces*/

	SD_SHADER_FLAGS = (SD_USE_MIS | SD_HAS_TRANSPARENT_SHADOW | SD_HAS_VOLUME |
					   SD_HAS_ONLY_VOLUME | SD_HETEROGENEOUS_VOLUME |
					   SD_HAS_BSSRDF_BUMP | SD_VOLUME_EQUIANGULAR | SD_VOLUME_MIS |
					   SD_VOLUME_CUBIC | SD_HAS_BUMP | SD_HAS_DISPLACEMENT | SD_HAS_CONSTANT_EMISSION | SD_USE_UNIFORM_ALPHA |
					   SD_USE_UNIFORM_ALPHA_SELF_ONLY | SD_OVERRIDE_SAMPLES | SD_OVERRIDE_BOUNCES)
};

enum ShaderDataObjectFlagss {
	/* object flags */
	SD_HOLDOUT_MASK             = (1 << 0),  /* holdout for camera rays */
	SD_OBJECT_MOTION            = (1 << 1),  /* has object motion blur */
	SD_TRANSFORM_APPLIED        = (1 << 2),  /* vertices have transform applied */
	SD_NEGATIVE_SCALE_APPLIED   = (1 << 3),  /* vertices have negative scale applied */
	SD_OBJECT_HAS_VOLUME        = (1 << 4),  /* object has a volume shader */
	SD_OBJECT_INTERSECTS_VOLUME = (1 << 5),  /* object intersects AABB of an object with volume shader */
	SD_OBJECT_HAS_VERTEX_MOTION = (1 << 6),  /* has position for motion vertices */
